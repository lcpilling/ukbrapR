ukbrap_paths = data.frame(
	object=c("death","death_cause","hesin","hesin_diag","gp_clinical","selfrep_illness"),
	path=c(
		"ukbrap_data/death.txt",
		"ukbrap_data/death_cause.txt",
		"ukbrap_data/hesin.txt",
		"ukbrap_data/hesin_diag.txt",
		"ukbrap_data/gp_clinical.txt",
		"ukbrap_data/selfrep_illness.txt.gz"
	)
)
